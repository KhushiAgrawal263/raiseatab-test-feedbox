  ...
  return (
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                            {
                                invoice.map((data)=>(
                                    ...
                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{data.date}</td>
    ...
    <div class="flex items-center justify-between mt-6">
        ...
        <div class="items-center hidden md:flex gap-x-3">
            ...
            <a href="#" class="px-2 py-1 text-sm text-gray-500 rounded-md dark:hover:bg-gray-800 dark:text-gray-300 hover:bg-gray-100">7</a>
        </div>
